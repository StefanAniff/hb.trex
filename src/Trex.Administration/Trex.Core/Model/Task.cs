...
namespace Trex.Core.Model
{
    ...
    public class Task : IEntity
    {
        ...
        public Task(string taskName, string description, User createdBy, DateTime createDate, double timeLeft, double timeEstimated, double bestCaseEstimate, double worstCaseEstimate, double realisticEstimate,
                    bool closed, Project project, Tag tag, Task parentTask)
            : this()
        {
            Name = taskName;
