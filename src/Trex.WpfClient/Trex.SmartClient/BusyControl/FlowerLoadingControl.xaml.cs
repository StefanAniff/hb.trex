...
namespace Trex.SmartClient.BusyControl
{
    public partial class FlowerLoadingControl : UserControl,IView
    {
        #region Constructors
        ...
        public FlowerLoadingControl()
        {
            ...
            InitializeComponent();
            this.ShowStoryboardAnimation = this.TryFindResource("ShowStoryBoard") as Storyboard;// this.ShowStoryboard; // Also part of the Visibility Pattern
            this.HideStoryboardAnimation = this.TryFindResource("HideStoryboard") as Storyboard; //this.HideStoryboard; // Also part of the Visibility Pattern
            Loaded += FlowerLoadingControl_Loaded;
            Color color = new Color { A = 255, R = 255 , B = 255, G = 255}; 
        ...
        private void FlowerLoadingControl_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            var loadingStoryBoard = this.TryFindResource("LoadingStoryboard") as Storyboard;
