...
{
    /// <summary>
    /// Scans object graph and appends values to textwriter.
    /// </summary>
    public class ObjectDumper
    {
        ...
        public static string DumpToString(object element)
        {
            var stringWriter = new StringWriter();
            Write(element, 10, stringWriter); // Let try with 10 levels of depth for now.
            stringWriter.Close();
