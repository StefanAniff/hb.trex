...
ADD DeliveredDate DATETIME 
GO

INSERT INTO Version ([Version], [Date], [Creator], [Description])
VALUES ('2.5.0.11', GETDATE(), 'RAB', 'Altered [spGetCustomersInvoiceView] to include customers without invoices, set Label for default cigs to "Default", added a column "DeliveredDate" to Invoices')
GO