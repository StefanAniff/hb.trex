...
--Joins cig and customers

/****** Object:  StoredProcedure [dbo].[spGetCustomerInvoiceGroupIdByCustomerId]    Script Date: 09/20/2012 15:46:15 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE PROCEDURE [dbo].[spGetCustomerInvoiceGroupIdByCustomerId]
@customerId int
AS
BEGIN
...
--Generates the new invoice draft

GO
/****** Object:  StoredProcedure [dbo].[spGenerateNewInvoiceDraft]    Script Date: 09/20/2012 15:51:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
