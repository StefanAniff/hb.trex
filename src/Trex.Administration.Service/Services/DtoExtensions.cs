...
namespace TrexSL.Web
{
    ...
    {
        public static List<Company> ToDtoObjects(this IEnumerable<Trex.Server.Core.Model.Customer> customers, bool includeParent, bool includeProjects, bool includeTasks, bool includeTimeEntries)
        {
            if (customers != null)
        ...
        public static Company ToDtoObject(this Trex.Server.Core.Model.Customer customer, bool includeParent, bool includeProjects, bool includeTasks, bool includeTimeEntries)
        {
